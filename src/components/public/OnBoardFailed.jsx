...
const OnBoardFailed = () => {
  ...
  const deepLinkURL = "barberonboardfailed://onboard/failed"; // Your custom URL scheme
  const fallbackURL = "https://www.admin.barbermeus.com/"; // Fallback if app not installed
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <div style={styles.success}>❌ Account Creation Failed!</div>
